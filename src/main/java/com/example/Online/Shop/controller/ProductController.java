...
public class ProductController implements ProductsApiDelegate {
	...
	@Override
	public ResponseEntity<ProductResponse> createProduct(String name, String description, String type, BigDecimal price,
			MultipartFile image, Integer stock) {
	...
	@Override
	public ResponseEntity<ProductResponse> updateProduct(Long productId, String name, String description, String type,
			BigDecimal price, MultipartFile image, Integer stock) {
