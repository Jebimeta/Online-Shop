...
public class CustomerTokenService {
	...
	// Revoca todos los tokens de acceso de un usuario asegurando que no puedan ser
	// utilizados nuevamente para autenticación
	...
	// Valida un refreshToken y si es válido, generar nuevos accessToken y actualización
	// para el usuario
