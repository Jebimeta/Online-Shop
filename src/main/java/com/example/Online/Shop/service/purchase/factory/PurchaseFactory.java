...
public class PurchaseFactory {
	...
	// Crea un objeto Purchase a partir de una solicitud de compra con los detalles del
	// cliente y los productos comprados
	public static Purchase createPurchaseFromPurchaseRequest(PurchaseRequest purchaseRequest, Customer customer,
		...
		return Purchase.builder()
			...
			.totalAmount(calculateToltalAmount(purchaseDetailsList)) // Calcula el monto
																		// final
			.shippingAddress(purchaseRequest.getShippingAddress()) // Dirección de envío
			.build();
	}

	// Calcula el monto total de la compra sumando el precio de cada item multiplicado por
	// su cantidad.
